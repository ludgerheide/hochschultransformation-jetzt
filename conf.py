...
BLOG_AUTHOR = "StIL-Jahresprogramm 2022/2023"  # (translatable)
BLOG_TITLE = "Hochschultransformation Jetzt!"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://hochschultransformation.jetzt/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://erfurter-impuls.de/"
BLOG_EMAIL = "jahresprogramm@stiftung-hochschullehre.de"
BLOG_DESCRIPTION = "Transformation zu mehr Nachhaltigkeit in der Hochschullehre"  # (translatable)
